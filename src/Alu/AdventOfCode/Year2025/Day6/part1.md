...
- `123` \* `45` \* `6` = `<em>33210</em>`
- `328` + `64` + `98` = `<em>490</em>`
- `51` \* `387` \* `215` = `<em>4243455</em>`
- `64` + `23` + `314` = `<em>401</em>`

To check their work, cephalopod students are given the *grand total* of adding together all of the answers to the individual problems. In this worksheet, the grand total is `33210` + `490` + `4243455` + `401` = `<em>4277556</em>`.
